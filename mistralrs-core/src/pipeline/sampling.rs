        ...
        */
        {
            ...
            let text = match reason {
                ...
                | crate::sequence::StopReason::ToolCalls => {
                    // Preserve the raw completion bytes verbatim. For BPE tokenizers
                    // the model's first predicted token frequently *is* a leading
                    // space (e.g. Llama-3 next-token " 0" after "470"); trimming
                    // corrupts the semantic meaning.
